//**********For Copy right this class copied from https://github.com/angiejones/email-test-automation******//
...
public class EmailUtils {
  ...
  public EmailUtils(String username, String password, String server, EmailFolder emailFolder) throws MessagingException {
    ...
    try {
      props.load(new FileInputStream(new File("configs/email.properties")));
    } catch(Exception e) {
      e.printStackTrace();
      System.exit(-1);
    }
